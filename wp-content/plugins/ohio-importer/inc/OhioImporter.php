	...
	private function final_response() {
		...
		//if ( empty( $this->frontend_error_messages ) ) {
			...
			$response['message'] .= sprintf(
				__( '%1$s%3$s<p class="title">Import Complete!</p> The demo template has been successfully imported.', 'ohio-importer' ),
				'<div class="notice o-notice success is-dismissible"><i class="icon"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"><path d="M382-336.16 176.92-541.23 219.69-584 382-421.69 740.31-780l42.77 42.77L382-336.16ZM220-180v-60h520v60H220Z"/></svg></i><div class="holder">',
				'<br>',
				'<p>',
				'</p>',
				'</div></div>'
